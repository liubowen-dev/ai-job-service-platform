...
class DocumentParseIntegrationTest {
    ...
    void setUp() {
        ...
        interview.guide.infrastructure.file.ocr.DocumentOcrService ocrService =
            org.mockito.Mockito.mock(interview.guide.infrastructure.file.ocr.DocumentOcrService.class);
        org.mockito.Mockito.when(ocrService.tryExtractText(
            org.mockito.ArgumentMatchers.any(),
            org.mockito.ArgumentMatchers.anyString(),
            org.mockito.ArgumentMatchers.anyString()
        )).thenReturn("");
        documentParseService = new DocumentParseService(textCleaningService, ocrService);
    }
